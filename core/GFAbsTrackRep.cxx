...
GFAbsTrackRep::GFAbsTrackRep() : fDimension(5), fState(5), fCov(5), fChiSqu(0), fNdf(0), fStatusFlag(0)
{
}

GFAbsTrackRep::GFAbsTrackRep(int dim) : fDimension(dim), fState(dim), fCov(dim), fChiSqu(0), fNdf(0), fStatusFlag(0)
{
}
