...
GFRaveTrackParameters::GFRaveTrackParameters(GFTrack* track, GFAbsTrackRep* rep, double weight, const TVectorT<double>& state6, const TMatrixTSym<double>& cov6x6, bool isSmoothed) :
