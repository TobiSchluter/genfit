...
#ifndef genfit_HMatrixUV6_h
#define genfit_HMatrixUV6_h
 ...
 *
 */
class HMatrixUV6 : public AbsHMatrix {
 ...
 public:
  ...
  virtual HMatrixUV6* clone() const {return new HMatrixUV6(*this);}

  virtual bool isEqual(const AbsHMatrix& other) const {return (dynamic_cast<const HMatrixUV6*>(&other) != NULL);}

  virtual void Print(const Option_t* = "") const;

  ClassDef(HMatrixUV6,1)
