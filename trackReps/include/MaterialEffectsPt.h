...
#ifndef genfit_MaterialEffectsPt_h
#define genfit_MaterialEffectsPt_h
 ...
 */
class MaterialEffectsPt : public TObject {

 private:

  MaterialEffectsPt();
  virtual ~MaterialEffectsPt();

  static MaterialEffectsPt* instance_;


public:

  static MaterialEffectsPt* getInstance();
  ...
  double effects(const std::vector<RKStepPt>& steps,
  ...
  */
  void stepper(const RKTrackRepPt* rep,
               M1x7& state7,
...
#endif // genfit_MaterialEffectsPt_h
