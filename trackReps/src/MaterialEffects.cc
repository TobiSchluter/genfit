                                ...
                                M7x7* noise)
{
  ...
  for ( std::vector<RKStep>::const_iterator it = materialsFXStart; it !=  materialsFXStop; ++it) { // loop over steps
    ...
    const MaterialProperties& material = it->materialProperties_;
...
#if 1  // Commented out, because unrelated to my current problem.
  // FIXME: verify formula, there may be a factor 1/sqrt(2) or similar missing ...
